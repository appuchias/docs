> Source: [drduh/YubiKey-Guide: Guide to using YubiKey for GPG and SSH](https://github.com/drduh/YubiKey-Guide#configure-smartcard)
...
![WSL agent architecture](schema_gpg.png)
